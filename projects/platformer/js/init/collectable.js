(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.steve, 500, 200, 4, 0.8);
        collectable.create(type.steve, 700, 250, 5, 1.1);
        collectable.create(type.steve, 500, 400, 3, 0.6);
        collectable.create(type.steve, 500, 500, 7, 0.9);
